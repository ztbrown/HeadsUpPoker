...
public class MatchPlayer
{
	...
	*/
	...
	{			
		...
		ArrayList<Object> winnerInfo = pot.payoutWinners(botHandStrengths);
		ArrayList<Integer> potParts = (ArrayList<Integer>) winnerInfo.get(0);
		ArrayList<ArrayList<PokerBot>> potPartWinners = (ArrayList<ArrayList<PokerBot>>) winnerInfo.get(1);
